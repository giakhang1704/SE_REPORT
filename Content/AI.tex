Trong quá trình làm bài tập lớn, nhóm có sử dụng các công cụ AI tạo sinh 
...
chuẩn DI (Dependency Injection), mẫu component và hook trong React. Những đoạn 
mã mẫu do AI cung cấp chỉ mang tính định hướng, nhóm sẽ triển khai lại 
theo phong cách lập trình và cấu trúc dự án của riêng mình.
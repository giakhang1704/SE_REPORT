...
\textbf{Post–Condition(s)} &
\begin{enumerate}
    \item Các khung giờ rảnh cũ của ngày được chọn bị xóa.
    \item Các khung giờ rảnh mới được lưu vào hệ thống.
    \item Lịch (Calendar) hiển thị cập nhật mới cho ngày vừa lưu.
\end{enumerate}
\\ \hline

\textbf{Normal Flow} &
\begin{enumerate}
    \item Tutor chọn mục “Lịch rảnh” (hoặc trong Hồ sơ cá nhân).
    \item Hệ thống hiển thị lịch theo tháng.
    \item Tutor chọn một ngày cụ thể.
    \item Hệ thống hiển thị danh sách các khung giờ rảnh hiện tại (nếu có).
    \item Tutor nhấn “Thiết lập lịch rảnh”.
    \item Hệ thống chuyển sang giao diện thiết lập lịch rảnh.
    \item Tutor thêm/xóa/chỉnh sửa các khung giờ rảnh.
    \item Tutor nhấn “Lưu”.
    \item Hệ thống kiểm tra dữ liệu hợp lệ.
    \item Hệ thống lưu dữ liệu và hiển thị thông báo “Lưu thành công”.
\end{enumerate}
\\ \hline

\textbf{Alternative Flow} &
\begin{enumerate}
    \item[3a.] Tutor chọn ngày trong quá khứ.
    \begin{enumerate}
        \item[3a1.] Hệ thống hiển thị thông báo: “Không thể chỉnh sửa ngày trong quá khứ”.
        \item[3a2.] Giao diện quay lại bước 2.
    \end{enumerate}

    \item[7a.] Trong quá trình thiết lập lịch rảnh, Tutor chọn “Hủy”.
    \begin{enumerate}
        \item[7a1.] Hệ thống quay lại giao diện lịch mà không lưu thay đổi.
        \item[7a2.] Use case kết thúc sớm.
    \end{enumerate}

    \item[8a.] Tutor nhập sai dữ liệu (giờ bắt đầu $a \geq b$ giờ kết thúc hoặc để trống).
    \begin{enumerate}
        \item[8a1.] Hệ thống hiển thị thông báo: “Vui lòng kiểm tra lại thời gian”.
        \item[8a2.] Giao diện quay lại bước 7.
    \end{enumerate}
\end{enumerate}
\\ \hline
...
\textbf{Exception Flow} &
\begin{enumerate}
    \item[E1.] Mất kết nối mạng khi lưu dữ liệu.
    \begin{enumerate}
        \item[E1.1.] Hệ thống hiển thị thông báo: “Không thể kết nối. Vui lòng thử lại sau”.
        \item[E1.2.] Hệ thống ghi log lỗi và không cập nhật dữ liệu.
        \item[E1.3.] Use case kết thúc không thành công.
    \end{enumerate}

    \item[E2.] Lỗi hệ thống trong quá trình xử lý.
    \begin{enumerate}
        \item[E2.1.] Hệ thống hiển thị thông báo: “Có lỗi xảy ra, vui lòng thử lại sau”.
        \item[E2.2.] Hệ thống ghi log lỗi và không cập nhật dữ liệu.
        \item[E2.3.] Use case kết thúc không thành công.
    \end{enumerate}
\end{enumerate}
\\ \hline

...
\textbf{Actor(s)} &Tutor \\ \hline
\textbf{Description} & 
Tutor xem và xử lý các yêu cầu đặt lịch hẹn từ sinh viên (phê duyệt hoặc từ chối) để xác nhận lịch hẹn với. \\ \hline

\textbf{Trigger} & 
Tutor bấm vào nút " Quản lí yêu cầu đặt lịch hẹn". \\ \hline
...
- Nếu duyệt: lịch hẹn được ghi nhận chính thức vào hệ thống. \newline
- Nếu từ chối: yêu cầu bị hủy và không ghi vào lịch. \\ \hline
...
\begin{enumerate}
    ...
    \item Hệ thống gửi thông báo kết quả xử lý cho sinh viên và cập nhật vào lịch Tutor.
\end{enumerate} \\ \hline
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item[4a1.] Hệ thống yêu cầu Tutor nhập lý do từ chối (tùy chọn).
        \item[4a2.] Tutor nhập lý do (hoặc bỏ trống) và xác nhận.
        \item[4a3.] Hệ thống ghi nhận quyết định từ chối và gửi thông báo cho sinh viên.
    \end{enumerate}

    \item[4b.] Tutor đổi ý và chọn “Hủy thao tác” trước khi xác nhận.
    \begin{enumerate}
        \item[4b1.] Hệ thống không lưu bất kỳ thay đổi nào.
        \item[4b2.] Giao diện quay lại danh sách yêu cầu.
...
\textbf{Exception Flow} & 
\begin{enumerate}
    \item[5a.] Khi ghi nhận quyết định (bước 5), hệ thống gặp lỗi cơ sở dữ liệu hoặc mất kết nối.
    \begin{enumerate}
        \item[5a1.] Hệ thống hiển thị thông báo: “Xử lý thất bại, vui lòng thử lại sau hoặc liên hệ bộ phận kỹ thuật”.
        \item[5a2.] Hệ thống ghi log lỗi, không thay đổi trạng thái yêu cầu.
        \item[5a3.] Use case kết thúc không thành công.
    \end{enumerate}
    \end{enumerate}
    - Mất kết nối mạng trong quá trình thêm lịch → Hệ thống hiển thị thông báo lỗi “Không thể kết nối. Vui lòng thử lại sau”. \newline

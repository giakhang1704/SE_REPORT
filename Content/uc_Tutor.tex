...
\textbf{Actor(s)} & Tutor \\ \hline
\textbf{Description} & Tutor xem và cập nhật lại danh sách các khung giờ rảnh trong một ngày cụ thể để học viên có thể đăng ký. \\ \hline
\textbf{Trigger} & Tutor bấm vào nút lịch rảnh trên giao diện hồ sơ cá nhân. \\ \hline

\textbf{Pre–Condition(s)} &
1. Tutor đã đăng nhập vào hệ thống thành công. \newline
2. Tài khoản có quyền hạn của Tutor. \newline
3. Hệ thống đang hoạt động bình thường. \\ \hline

\textbf{Post–Condition(s)} &
1. Các khung giờ rảnh cũ của ngày đó bị xóa bỏ. \newline
2. Các khung giờ rảnh mới được lưu vào hệ thống. \newline
3. Giao diện lịch (Calendar) hiển thị cập nhật cho ngày vừa lưu. \\ \hline

\textbf{Normal Flow} &
1. Tutor chọn mục “Lịch rảnh” (hoặc Hồ sơ cá nhân). \newline
2. Hệ thống hiển thị lịch theo tháng. \newline
3. Tutor chọn một ngày cụ thể. \newline
4. Hệ thống hiển thị danh sách các khung giờ rảnh hiện tại. \newline
5. Tutor nhấn “Thiết lập lịch rảnh”. \newline
6. Hệ thống chuyển sang giao diện thiết lập lịch rảnh. \newline
7. Tutor thêm/xóa/sửa các khung giờ. \newline
8. Tutor nhấn “Lưu”. \newline
9. Hệ thống hiển thị thông báo “Lưu thành công”. \\ \hline

\textbf{Alternative Flow} &
3a. Chọn ngày quá khứ $\rightarrow$ hệ thống chặn chỉnh sửa. \newline
7a. Nhấn “Hủy” $\rightarrow$ quay lại không lưu. \newline
8a. Nhập sai (start $\ge$ end, để trống) $\rightarrow$ báo lỗi. \\ \hline

\textbf{Exception Flow} &
E1. Mất mạng lúc Lưu $\rightarrow$ báo lỗi kết nối. \newline
E2. Lỗi hệ thống $\rightarrow$ báo lỗi và ghi log. \\ \hline

...
\textbf{Description} & Cho phép sinh viên hủy buổi tư vấn, lịch hẹn đã đăng ký với tutor khi có thay đổi trong lịch trình hoặc không thể tham gia. \\ \hline
...
\textbf{Normal flow} & 
1. Sinh viên chọn “Hủy đăng ký”. \newline
2. Hệ thống hiển thị danh sách buổi gặp mặt. \newline
3. Sinh viên chọn buổi muốn hủy. \newline
4. Hệ thống yêu cầu xác nhận. \newline
5. Sinh viên xác nhận. \newline
6. Hệ thống kiểm tra thời gian. \newline
7. Hệ thống gửi thông báo “Hủy thành công”. \\ \hline
\textbf{Alternative flow} & 
2a. Không có buổi gặp mặt đã đăng ký → Hệ thống hiển thị “Không có buổi gặp mặt nào”. \newline
6a. Buổi gặp mặt đã bắt đầu → Hệ thống hiển thị “Không thể hủy vì buổi gặp mặt đã bắt đầu”. \\ \hline
\textbf{Exception flow} & 
